...
router.get('/', authorize(['ADMIN', 'HR_MANAGER', 'HR_PAYROLL_USER', 'HR_PAYROLL_MANAGER']), contractsController.getContracts);
router.get('/:id', authorize(['ADMIN', 'HR_MANAGER', 'HR_PAYROLL_USER', 'HR_PAYROLL_MANAGER']), contractsController.getContractById);
...
router.delete('/:id', authorize(['ADMIN', 'HR_MANAGER']), contractsController.deleteContract);
