...
router.post('/structures', authorize(['ADMIN', 'HR_MANAGER', 'HR_PAYROLL_MANAGER']), payrollController.createSalaryStructure);
...
router.patch('/structures/:id', authorize(['ADMIN', 'HR_MANAGER', 'HR_PAYROLL_MANAGER']), payrollController.updateSalaryStructure);

// Payruns
router.get('/payruns', authorize(['ADMIN', 'HR_MANAGER', 'HR_PAYROLL_USER', 'HR_PAYROLL_MANAGER']), payrollController.getPayruns);
router.post('/payruns', authorize(['ADMIN', 'HR_MANAGER', 'HR_PAYROLL_USER', 'HR_PAYROLL_MANAGER']), payrollController.createPayrun);
router.get('/payruns/:id', authorize(['ADMIN', 'HR_MANAGER', 'HR_PAYROLL_USER', 'HR_PAYROLL_MANAGER']), payrollController.getPayrunById);
router.post('/payruns/:id/compute', authorize(['ADMIN', 'HR_MANAGER', 'HR_PAYROLL_USER', 'HR_PAYROLL_MANAGER']), payrollController.computePayrun);
router.post('/payruns/:id/validate', authorize(['ADMIN', 'HR_MANAGER', 'HR_PAYROLL_USER', 'HR_PAYROLL_MANAGER']), payrollController.validatePayrun);
router.post('/payruns/:id/pay', authorize(['ADMIN', 'HR_MANAGER', 'HR_PAYROLL_USER', 'HR_PAYROLL_MANAGER']), payrollController.markPayrunPaid);
