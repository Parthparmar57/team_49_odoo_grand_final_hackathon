...
// Salary Structures
router.get('/structures', authorize(['ADMIN', 'HR_PAYROLL_USER', 'HR_PAYROLL_MANAGER']), payrollController.getSalaryStructures);
router.post('/structures', authorize(['ADMIN', 'HR_PAYROLL_MANAGER']), payrollController.createSalaryStructure);
router.get('/structures/:id', authorize(['ADMIN', 'HR_PAYROLL_USER', 'HR_PAYROLL_MANAGER']), payrollController.getSalaryStructureById);
...
router.get('/payslips/:id', authorize(['ADMIN', 'HR_PAYROLL_USER', 'HR_PAYROLL_MANAGER', 'EMPLOYEE']), payrollController.getPayslipById);
router.get('/payslips/:id/pdf', authorize(['ADMIN', 'HR_PAYROLL_USER', 'HR_PAYROLL_MANAGER', 'EMPLOYEE']), payrollController.downloadPayslipPdf);
